...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.labelStrategy = QtWidgets.QLabel(parent=self.tabHeZhou)
        self.labelStrategy.setGeometry(QtCore.QRect(310, 39, 911, 671))
        self.labelStrategy.setStyleSheet("border: 2px solid #ffffff; /* 设置边框和颜色 */\n"
"border-radius: 20px; /* 设置圆角半径 */\n"
"background-color: rgb(20, 20, 20);")
        self.labelStrategy.setText("")
        self.labelStrategy.setObjectName("labelStrategy")
        self.line = QtWidgets.QFrame(parent=self.tabHeZhou)
        self.line.setGeometry(QtCore.QRect(460, 190, 511, 261))
...
"border-color: transparent;")
        ...
        self.btnMiniMainWindow = QtWidgets.QPushButton(parent=Form)
        self.btnMiniMainWindow.setGeometry(QtCore.QRect(1220, 0, 30, 30))
        self.btnMiniMainWindow.setText("")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("imgs/ico/mini.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btnMiniMainWindow.setIcon(icon6)
        self.btnMiniMainWindow.setIconSize(QtCore.QSize(25, 25))
        self.btnMiniMainWindow.setObjectName("btnMiniMainWindow")
        self.frametab.raise_()
        self.tab.raise_()
        self.btnDestroyMainWindow.raise_()
        self.btnMiniMainWindow.raise_()

        self.retranslateUi(Form)
        self.tab.setCurrentIndex(0)
        self.preset.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(Form)
        Form.setTabOrder(self.btnHeZhou, self.btnCalcu)
        Form.setTabOrder(self.btnCalcu, self.btnChara_1)
        Form.setTabOrder(self.btnChara_1, self.btnChara_2)
        Form.setTabOrder(self.btnChara_2, self.btnChara_3)
        Form.setTabOrder(self.btnChara_3, self.btnSaveStrategy)
        Form.setTabOrder(self.btnSaveStrategy, self.btnCC_1)
        Form.setTabOrder(self.btnCC_1, self.btnCC_2)
        Form.setTabOrder(self.btnCC_2, self.btnCC_3)
        Form.setTabOrder(self.btnCC_3, self.pushButton)
        Form.setTabOrder(self.pushButton, self.btnChara)
        Form.setTabOrder(self.btnChara, self.btnDestroyMainWindow)
        Form.setTabOrder(self.btnDestroyMainWindow, self.btnMiniMainWindow)
